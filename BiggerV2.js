...
for(key in ele){
     var iEle = ele[key];
     var realEle = {
         "last_close":iEle.last_close,  
         "low52week":iEle.low52week,  
         "high52week":iEle.high52week,  
         "marketCapital":iEle.marketCapital,  
         "pe_lyr":iEle.pe_lyr,  
         "pe_ttm":iEle.pe_ttm,  
         "name":iEle.name  
     };
     
     console.log(iEle.symbol,iEle.last_close,iEle.low52week,iEle.high52week,iEle.marketCapital, iEle.name ,iEle.pb,iEle.psr,iEle.pe_lyr,iEle.pe_ttm);
     //console.log("\n");
     realInfo.push(realEle);
     //console.log(realEle);
